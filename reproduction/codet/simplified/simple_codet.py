...
SOLUTIONS_PATH = os.path.join(CACHE_DIR, "codet_output", "solutions.jsonl")
TESTS_PATH = os.path.join(CACHE_DIR, "codet_output", "tests.jsonl")
GROUND_TRUTH_PATH = os.path.join(BASE_DIR, "..", "..", "..", "datasets", "mbpp", "sanitized-mbpp.json")
RESULTS_PATH = os.path.join(RESULTS_DIR, "simple_codet_results.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, default=os.path.join(CACHE_DIR, "codet_output"), help="Path to CodeT input directory")
    ...
    RESULTS_PATH = os.path.join(RESULTS_DIR, f"simple_codet_results_{dir_name}.json")
