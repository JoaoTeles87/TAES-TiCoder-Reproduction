...
| :--- | :--- | :--- |
| **Pass@1** | 70.33% | **75.83%** |
| **Pruned Pass@1** | 71.0% | **75.83%** |
| **Pass@5** | 75.0% | **80.0%** |

**Conclusion:**
In this specific controlled subset, **CodeT outperformed TiCoder**. This suggests that for this batch of problems, the "consensus" of the model was a strong signal, possibly stronger than the tests generated by the SLM. This highlights that TiCoder's performance is dependent on the quality of generated tests; if tests are weak, the Oracle cannot effectively prune bad candidates, whereas CodeT's consensus might still identify the correct logic if the model is confident.
