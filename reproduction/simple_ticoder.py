...
CACHE_PATH = os.path.join(BASE_DIR, "ticoder_cache.json")
GROUND_TRUTH_PATH = os.path.join(BASE_DIR, "../datasets/mbpp/sanitized-mbpp.json")
RESULTS_PATH = os.path.join(BASE_DIR, "simple_ticoder_results.json")
...
if __name__ == "__main__":
    ...
    RESULTS_PATH = os.path.join(BASE_DIR, f"simple_ticoder_results_{name_without_ext}.json")
